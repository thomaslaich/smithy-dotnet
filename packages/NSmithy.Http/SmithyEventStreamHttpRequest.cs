...
public sealed class SmithyEventStreamHttpRequest(HttpMethod method, string requestUri)
{
    ...
    public IAsyncEnumerable<SmithyEventFrame> Events { get; set; } =
        AsyncEnumerable.Empty<SmithyEventFrame>();
