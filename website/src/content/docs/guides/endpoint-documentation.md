...
```xml
<PackageReference Include="NSmithy.Server.AspNetCore.Docs" Version="NSMITHY_VERSION" />
```
...
Both properties are disabled by default. Sphinx generation requires Python 3.11+
on the build host.
