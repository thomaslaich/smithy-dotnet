...
public sealed class CSharpShapeGeneratorTests
{
    ...
    [Fact]
    public void GenerateTreatsInputMembersAsNullableForNonAuthoritativeClients()
    {
        var model = SmithyJsonAstReader.Read(
            """
            {
    ...
    [Fact]
    public void GenerateCanUseAuthoritativeNullabilityForInputMembers()
    {
        var model = SmithyJsonAstReader.Read(
            """
            {
        ...
        var file = new CSharpShapeGenerator()
            .Generate(
                model,
                new CSharpGenerationOptions(NullabilityMode: CSharpNullabilityMode.Authoritative)
            )
            .Single();
