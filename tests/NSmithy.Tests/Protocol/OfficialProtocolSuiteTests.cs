...
using NSmithy.CodeGeneration.CSharp;
        ...
        await File.WriteAllTextAsync(
            ...
            <Project Sdk="Microsoft.NET.Sdk">
              ...
              <ItemGroup>
                ...
                <ProjectReference Include="{{FindRepositoryRoot()}}/src/NSmithy.Codecs.Cbor/NSmithy.Codecs.Cbor.csproj" />
                <ProjectReference Include="{{FindRepositoryRoot()}}/src/NSmithy.Client/NSmithy.Client.csproj" />
                <ProjectReference Include="{{FindRepositoryRoot()}}/src/NSmithy.Client.RestJson/NSmithy.Client.RestJson.csproj" />
                <ProjectReference Include="{{FindRepositoryRoot()}}/src/NSmithy.Client.RestXml/NSmithy.Client.RestXml.csproj" />
                <ProjectReference Include="{{FindRepositoryRoot()}}/src/NSmithy.Client.RpcV2Cbor/NSmithy.Client.RpcV2Cbor.csproj" />
                <ProjectReference Include="{{FindRepositoryRoot()}}/src/NSmithy.Core/NSmithy.Core.csproj" />
                <ProjectReference Include="{{FindRepositoryRoot()}}/src/NSmithy.Http/NSmithy.Http.csproj" />
                <ProjectReference Include="{{FindRepositoryRoot()}}/src/NSmithy.Codecs/NSmithy.Codecs.csproj" />
                <ProjectReference Include="{{FindRepositoryRoot()}}/src/NSmithy.Server.AspNetCore/NSmithy.Server.AspNetCore.csproj" />
                <ProjectReference Include="{{FindRepositoryRoot()}}/src/NSmithy.Server/NSmithy.Server.csproj" />
              </ItemGroup>
            </Project>
            """
        );
    ...
    private static async Task WriteProjectAsync(string projectDirectory)
    {
        await File.WriteAllTextAsync(
            ...
            <Project Sdk="Microsoft.NET.Sdk.Web">
              ...
              <ItemGroup>
                <ProjectReference Include="{{OfficialGeneratedClientConformanceRunner.FindRepositoryRoot()}}/src/NSmithy.Client.RestJson/NSmithy.Client.RestJson.csproj" />
                <ProjectReference Include="{{OfficialGeneratedClientConformanceRunner.FindRepositoryRoot()}}/src/NSmithy.Client.RestXml/NSmithy.Client.RestXml.csproj" />
                <ProjectReference Include="{{OfficialGeneratedClientConformanceRunner.FindRepositoryRoot()}}/src/NSmithy.Client.RpcV2Cbor/NSmithy.Client.RpcV2Cbor.csproj" />
                <ProjectReference Include="{{OfficialGeneratedClientConformanceRunner.FindRepositoryRoot()}}/src/NSmithy.Core/NSmithy.Core.csproj" />
                <ProjectReference Include="{{OfficialGeneratedClientConformanceRunner.FindRepositoryRoot()}}/src/NSmithy.Codecs.Json/NSmithy.Codecs.Json.csproj" />
                <ProjectReference Include="{{OfficialGeneratedClientConformanceRunner.FindRepositoryRoot()}}/src/NSmithy.Server.AspNetCore/NSmithy.Server.AspNetCore.csproj" />
                <ProjectReference Include="{{OfficialGeneratedClientConformanceRunner.FindRepositoryRoot()}}/src/NSmithy.Server/NSmithy.Server.csproj" />
              </ItemGroup>
            </Project>
            """
        );
